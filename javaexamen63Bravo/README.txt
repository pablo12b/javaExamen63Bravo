...
a persistence unit "javaexamen63BravoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "javaexamen63Bravo/pom.xml":
...
artifact ("javaexamen63Bravo.war") is already built. You can build
